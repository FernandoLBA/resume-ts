...
exports.deleteEnterprise = exports.updateEnterprise = exports.createEnterprise = exports.getUsersByEnterprise = exports.getEnterprise = exports.getAllEnterprises = void 0;
...
const getAllEnterprises = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield (0, services_1.getAllEnterprisesService)();
 ...
 * @returns
 */
const getEnterprise = ({ params: { id } }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield (0, services_1.getEnterpriseService)(id);
        if (!data)
 ...
 * @returns
 */
const getUsersByEnterprise = ({ params: { id } }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield (0, services_1.getUsersByEnterpriseService)(id);
        if (!data.length)
            return (0, utils_1.handleErrorHttpController)(res, "ITEMS_NOT_FOUND", 404);
        (0, utils_1.handleHttpResponses)(res, "Users listed by Enterprise", data);
    }
    catch (error) {
        (0, utils_1.handleErrorHttpController)(res, "ERROR_GET_MIXING_ITEMS", 500, JSON.stringify(error));
    }
});
exports.getUsersByEnterprise = getUsersByEnterprise;
/**
 *
 * @param param0
 * @param res
 * @returns
 */
const createEnterprise = ({ body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { item: data, created } = yield (0, services_1.createEnterpriseService)(body);
        if (!created)
 ...
 * @param res
 */
const updateEnterprise = ({ params: { id }, body }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield (0, services_1.updateEnterpriseService)(id, body);
        if (!data)
            return (0, utils_1.handleErrorHttpController)(res, "ITEM_NOT_FOUND", 404);
 ...
 * @param res
 */
const deleteEnterprise = ({ params: { id } }, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield (0, services_1.deleteEnterpriseService)(id);
        if (!data)
            return (0, utils_1.handleErrorHttpController)(res, "ITEM_NOT_FOUND", 404);
